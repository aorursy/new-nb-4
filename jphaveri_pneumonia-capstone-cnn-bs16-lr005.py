...
class generator(keras.utils.Sequence):
    ...
    def __init__(self, folder, filenames, pneumonia_locations=None, batch_size=64, image_size=256, shuffle=True, augment=False, predict=False):
...
model.save('model_bs128_lr005.h5')
