...
train_df['title_text'] = 'title: ' + train_df['title'] + ' text: '+ train_df['text']
...
X_train, X_test = pd.concat([train_df['title_text'], val_df['title_text']]).values, test_df['title_text'].values
...
pd.DataFrame(label_encoder.inverse_transform(preds), 
