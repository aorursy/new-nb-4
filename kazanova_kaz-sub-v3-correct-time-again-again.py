...
model_directory= "/kaggle/input/model-v-9/model"
...
use_external=False #True to use WM data
...
#### THESE WERE PRODUCED BY AVERAGING MY MODEL'S PREDICTIONS AT STATE LEVEL

##### I ADDED SOME CONSTANT VALUE BASED ON JUDGEMENT TOO
...
# GAHANA REPORTS 0 EVERY 2 DAYS - i Manually changed prediction to acocunt for that.
...
add_3_constants["nan_Quebec_Canada"]=[ [100,200,150] , [20,20,20]   ]  # **************maybe rate is better
...
add_constant_rate["nan_nan_Peru"]=[0.005,0.001]
