...
collab_jac10 = collaborative_filter(s_train, s_input, sim_fn=jaccard_sim, j=25, k=k_top)
...
collab_cos10 = collaborative_filter(s_train, s_input, sim_fn=cosine_sim, j=44, k=k_top)
...
print("Similarity: Hybrid (0.1 * Jaccard + 0.9 * Cosine)")
