...
# seed_everything(42)
# tensorflow実行時に必要な分だけGPUメモリを確保する設定
...
train.head()
train.groupby('SmokingStatus').count()['FVC']
# def get_tab(df):
...
#     return cv2.resize(d.pixel_array / 2**11, (512, 512))
# check the bat id's
train[train['Patient']=='ID00011637202177653955184']
# check the bat id's
train[train['Patient']== 'ID00052637202186188008618']
