...
model = create_network(input_size=256, channels=32, n_blocks=1, depth=5)
...
def cosine_annealing(x,epochs = 23):
...
history = model.fit_generator(train_gen, validation_data=valid_gen, callbacks=[learning_rate], epochs=23, shuffle=True)
