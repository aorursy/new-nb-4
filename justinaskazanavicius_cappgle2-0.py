...
# Original: https://www.kaggle.com/abhishek/optimizer-for-quadratic-weighted-kappa
...
#test_predictions = rounder.predict(test_predictions, coefficients)
...
Learner.TTA = _TTA
def run_subm(learn, rounder_coefficients=[0.5, 1.5, 2.5, 3.5], tta=True):
...
learn.load('abcdef'); # Initial model taken from fork
...
# Load best model found during fine-tunning

learn.load('bestmodel')
# # Getting valid predictions from the validation dataset
...
test_df_tta = run_subm(learn=learn, rounder_coefficients=rounder_coefficients, tta=TTA) # No TTA, memory issues
# test_df['diagnosis'].value_counts()
test_df_tta['diagnosis'].value_counts() # TTA