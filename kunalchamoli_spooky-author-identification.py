...
clf.fit(xtrain_tfv.tocsc(), ytrain)    #.tocsc()-> Convert this matrix to Compressed Sparse Column format.
...
print ("logloss: %0.3f " % multiclass_logloss(yvalid, predictions))
# Fitting a simple xgboost on countverctorizer
...
clf = pipeline.Pipeline([('svd', svd),
                         ...
                         ('lr', lr_model)])
param_grid = {'svd__n_components' : [120, 180],#Grid Of Parameters
