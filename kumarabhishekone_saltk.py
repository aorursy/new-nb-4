...
ids=['1f1cc6b3a4','5b7c160d0d','6c40978ddf','7dfdf6eeb8','7e5a6e5013','7845115d01']
...
print('Done')
# checking if the data looks alright
...
X_test=np.zeros((len(test_ids), im_hieght, im_width, im_chan), dtype= np.uint8)
sizes_test = []
