...
train = train[['Province_State','Country_Region','Date','ConfirmedCases','Fatalities']]
...
dtcla = DecisionTreeClassifier(random_state=1000)
...
features1=['Date','Province_State','Country_Region']
...
dtcla.fit(train[features1],train[target1])
#Make predictions using the features from the test data set

predictions1 = dtcla.predict(test[features1])
