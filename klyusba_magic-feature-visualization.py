...
train_test['magic3'] = train_test[ID_COLUMN].diff().fillna(0).astype(int)

train_test['magic4'] = train_test[ID_COLUMN].iloc[::-1].diff().fillna(0).astype(int)
train_test['t'] = train_test['magic3'] * train_test['magic4']
train_test['t2'] = train_test['magic3'] + train_test['magic4']
