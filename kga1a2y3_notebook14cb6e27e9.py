...
def sample_vals(df, price_value, ratio, condition, seed):
    ...
    indices = condition(df.price_doc, price_value) & (df.product_type == 'Investment')
...
train = sample_vals(train, 1000000, 1/8, le, seed=1)

train = sample_vals(train, 2000000, 1/4, eq, seed=1)
